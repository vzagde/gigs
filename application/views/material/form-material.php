            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Materail Checkbox</h4>
                                <h6 class="card-subtitle">Just add <code>checkbox-mb</code> class to input</h6>
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="label--checkbox">
                                            <input type="checkbox" class="checkbox-mb" checked> Item 1
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="label--checkbox">
                                            <input type="checkbox" class="checkbox-mb"> Item 2
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="label--checkbox">
                                            <input type="checkbox" class="checkbox-mb"> Item 3
                                        </label>
                                    </div>
                                    <div class="col-md-3">
                                        <label class="label--checkbox">
                                            <input type="checkbox" class="checkbox-mb"> Item 4
                                        </label>
                                    </div>
                                </div>
                                <h4 class="card-title m-t-40">Materail Radio button</h4>
                                <h6 class="card-subtitle">Just add <code></code> class to input</h6>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div>
                                            <div class="md-radio">
                                                <input id="11" type="radio" name="gx" checked>
                                                <label for="11">Option 1</label>
                                            </div>
                                            <div class="md-radio">
                                                <input id="12" type="radio" name="gx">
